...
export const monitoringService = {
  ...
  getEstadoServicios: () =>
    api.get(`${BASE}/salud/`).then((r) => r.data),

  /** CPU, RAM, disco y contenedores Docker. */
  getInfraestructura: () =>
    api.get(`${BASE}/infraestructura/`).then((r) => r.data),
  ...
  getBaseDatos: () =>
    api.get(`${BASE}/base-datos/`).then((r) => r.data),

  /** Indicadores de negocio SACARF. */
  getNegocio: () =>
    api.get(`${BASE}/negocio/`).then((r) => r.data),

  /** Todo el dashboard en una sola petición. */
  getResumen: () =>
    api.get(`${BASE}/resumen/`).then((r) => r.data),
  ...
  getAuditoriaResumen: () =>
    api.get(`${BASE}/auditoria/resumen/`).then((r) => r.data),
};
